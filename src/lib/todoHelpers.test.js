...
test('addTodo should add the passed todo onto the list', () => {
    const startTodos = [
...
test('updateTodo should update an item by id', () => {
    ...
    const result = updateTodos(startTodos, updatedTodos)
...
test('filterTodos should return only active items for the active route', () => {
    const startTodos = [
        {id:1, name: 'one', isComplete: false},
        {id:2, name: 'two', isComplete: true},
        {id:3, name: 'three', isComplete: false}
