...
class App extends Component {
  ...
  handleToggle = (id) => {
    ...
    saveTodo(updated)
      .then(() => this.showTempMessage('Oppgaven er oppdatert'))
  }
  ...
  handleSubmit = (evt) => {
    evt.preventDefault()
      ...
      createTodo(newTodo)
        .then(() => this.showTempMessage('Oppgaven er lagt til'))
  }
  ...
  handleEmptySubmit = (evt) => {
    evt.preventDefault()
    this.setState({
      errorMessage: 'Vennligst skriv inn en oppgave'
    })
  }
  ...
  handleRemove = (id, evt) => {
    ...
    this.setState({todos: updatedTodos})
    destroyTodo(id)
      .then(() => this.showTempMessage('Oppgaven er slettet'))
  }
